...
func (tr *storeTxnRead) rangeKeys(key, end []byte, curRev int64, ro RangeOptions) (*RangeResult, error) {
	//1.如果传参中没有指定reversion,那么就返回当前reversion以下的所有实例
	rev := ro.Rev
	if rev > curRev {
	...
	//3.从内存中的 key-->reversion的映射中,查找key对应的版本号集合.
